...
function fromPercent(currentPower, limitPower) {
...
function fromMinAlpha(alpha) {
    return { percentage: data[alpha], alpha: alpha };
}

module.exports = { fromPercent: fromPercent, fromMinAlpha: fromMinAlpha };