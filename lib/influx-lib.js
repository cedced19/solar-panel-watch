...
module.exports = {
    ...
    writeVar: writeVar,
    daemon: daemon, 
    requestLastData: requestLastData, 
    requestDataOverPeriod: requestDataOverPeriod, 
    requestDataOverPeriodGroupBy: requestDataOverPeriodGroupBy,
